...
class Moves {
	...
	public function load_construct($client_id,$client_secret,$redirect_url,$oauth_url = 'https://api.moves-app.com/oauth/v1/', $api_url = 'https://api.moves-app.com/api/1.1') {
	...
	public function get_range($access_token, $endpoint = '', $params=array()) {
		$params['access_token'] = $access_token;
		return $this->get($params, $endpoint);
	}
